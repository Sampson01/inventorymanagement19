            ...
            -->
                           ...
                           <div class="container" id="loginDiv">
                                 ...
                                 <form class="form-signin" action="includes/login.inc.php" method="post">
                                   ...
                                   <input type="text" id="inputEmail" class="form-control" name="mailuid" placeholder="Staff ID">

                                   <label for="psw" class="sr-only">Password</label>
                                   <input type="password" id="inputPassword" class="form-control" name="pwd" placeholder="Password" name="psw">
                           <center>
