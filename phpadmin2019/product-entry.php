...
<body>
 ...
 <span class="menu"><a id="product-editor" class="btn btn-success" href="./product-editor.html">Product Editor</a><a id="Product Billing" class="btn btn-success" href="./billing.html">Product Billing</a></span>
...
<form >
  ...
  <div class="form-group">
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control" id="exampleInputAmount" placeholder="Enter Product Name">
    </div>
</div>
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control" id="exampleInputAmount" placeholder="Enter Purchased Price">
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control" id="exampleInputAmount" placeholder="Enter Selling Price">
    <div class="input-group-addon">.00</div>
  ...
  <div class="form-group">
    ...
    <div class="input-group">
      ...
      <input type="number" class="form-control" id="exampleInputAmount" placeholder="Enter Quantity">
      <!-- <div class="input-group-addon">.00</div> -->
    </div>
  </div>
